...
const ExternalProject = ({ externalProjects, loading, googleAnalytics }) => {
  ...
  const renderExternalProjects = () => {
    return externalProjects.map((item, index) => (
      ...
      >
        <div className="p-8 pt-6 pb-4 h-full w-full">
          <div className="flex items-center flex-col">
            <div className="w-full">
              <div className="px-4">
                <div className="text-center w-full">
                  ...
                  {item.imageUrl && (
                    <div className="avatar">
                      <div style={{opacity: index === 5 ? 0.8 : index === 4? 0.9 : 1, border: "1px solid #333", borderRadius: "5px", height: "112px", width: "200px"}}>
                        <LazyImage
                          src={item.imageUrl}
                          alt={'thumbnail'}
        ...
        <div className="col-span-1 lg:col-span-2">
          <div className="grid grid-cols-2 gap-6">
            <div className="col-span-2">
              <div style={{border: "1px solid gray", borderRadius: "10px"}} className="card compact bg-base-100 shadow bg-opacity-40">
                  ...
                  <div className="mx-3 flex items-center justify-between mb-2">
                    <h5 className="card-title">
                      {loading ? (
                        ...
                        <h1 style={{fontSize: "25px", fontWeight: "bold"}} className="text-base-content opacity-70">
                          Projects
                        </h1>
                      )}
                    </h5>
