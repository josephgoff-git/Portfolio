...
const GitProfile = ({ config }) => {
  ...
  useEffect(() => {
    theme && document.documentElement.setAttribute('data-theme', "black");
  }, [theme]);
  ...
  const loadData = useCallback(() => {
    axios
      ...
      .then((userData) => {
        ...
        // console.log(sanitizedConfig.github.exclude.projects)
        ...
        let url = `https://api.github.com/search/repositories?q=${query}&sort=${sanitizedConfig.github.sortBy}&per_page=100&type=Repositories`;
